...
const BRANDS = [
  ...
  { logo: "/brands/motorola.png", name: "Motorola" },
  { logo: "/brands/xiaomi.png",  name: "Xiaomi"   },
...
export default function Page() {
  ...
  return (
    <>
      ...
      {/* ── HERO ────────────────────────────────────────── */}
      <section className="hero-wrap-section" style={{ paddingTop: 110, paddingBottom: 80, position: "relative", zIndex: 1 }}>
